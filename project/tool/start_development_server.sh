...
sudo docker run --rm -ti -p 80:80 -p 8080:8080 -p 3306:3306 --name mvc_admin_frame \
    ...
    -v $ROOT_DIR/project/config/development/supervisor/mvc_admin_frame_queue_worker.conf:/etc/supervisor/conf.d/queue_worker.conf \
